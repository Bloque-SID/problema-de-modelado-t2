REM   Script: PokemonTrainersAPP_DB
REM   App for pokemon trainers
...
CREATE SEQUENCE ID_objectpk_seq START WITH 1;

CREATE TABLE ObjectPk(  
    ID INTEGER DEFAULT ID_objectpk_seq.NEXTVAL NOT NULL,  
    name VARCHAR(15) NOT NULL, 
...
CREATE TABLE BattleSet(  
    pokemon INTEGER UNIQUE NOT NULL,  
    ...
    FOREIGN KEY(objectpk) REFERENCES ObjectPk(ID) 
);
